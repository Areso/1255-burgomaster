...
locObj.knightLearnCurve = { "txt": "Havas grandan ŝancon pliigi ATK kiam altnivele", "loc": "short description of the class in inn" };
locObj.monkLearnCurve = { "txt": "Havas grandan ŝancon pliigi DEF kiam altnivele", "loc": "short description of the class in inn" };
locObj.heroClassKnight = { "txt": "Kavaliro", "loc": "The inn when we are hiring. Hero class" };
locObj.heroClassMonk = { "txt": "Monako", "loc": "The inn when we are hiring. Hero class" };

locObj.heroLvlLbl = { "txt": "nivelo", "loc": "The inn when we are hiring. Level" };
locObj.heroStatsLbl = { "txt": "Statistikoj: ", "loc": "The inn when we are hiring. Stats" };
locObj.heroStatsAtkLbl = { "txt": "Atako", "loc": "The inn when we are hiring. Stats. Attack" };
...
locObj.requiredStables = { "txt": "Por fari tion, vi devas konstrui la stalon", "loc": "happens when trying to hire sergeants if no stables built" };
...
locObj.eventHalloweenName = { "txt": "Hallovin", "loc": "shows on the status bar if the event announced or online" };
locObj.eventNewYearName = { "txt": "Nova Jaro", "loc": "shows on the status bar if the event announced or online" };
locObj.yes = { "txt": "Jes", "loc": "Positive answer, happens in modal dialogues" };
locObj.yesKillBloody = { "txt": "Jes, plej sange!", "loc": "NOT USED YET" };
...
locObj.rqtsFountain = { "txt": "Postulas %arg1 civitanon por malŝlosi", "loc": "Reqs for Fountain" };
...
locObj.lblAbout_supLang = {
  "txt": "Apogita Lingvoj (AL): Angla, Rusa.\n" +
...
locObj.tabPopHistory = { "txt": "langeto pri civitanaj historio", "loc": "Label in Pop history tab" };
locObj.tabPopHistoryCurrentLimit = { "txt": "Nuna populacio limo estas %arg1", "loc": "Label current pop limit" };
locObj.tabGoldHistoryCurrentLimit = { "txt": "Nuna ora limo estas %arg1", "loc": "label current gold limit" };
locObj.tabGoldHistory = { "txt": "langeto pri mono historio", "loc": "Label in Gold history tab" };

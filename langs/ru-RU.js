...
locObj.tutorial_defense = {"txt":"Герр Комтур, разведчики доложили о воруженных людях\n в ближайших лесах. Вам следует построить крепостную стену", "loc":"сообщение из туториала при разблокировке защитных зданий"};
...
locObj.story2_two_steps = {"txt":"Вы увидели крестьян, убегающих от уродливых монстров, которых вы никогда не видели\nВы убили монстров и спросили крестьян, что произошло\nОни ответили, что тролли выбесились, потому что крестьяне не заплатили за право прохода...", "loc":"tutorial. when you step 2 times from city"};
...
locObj.new_adepts = {"txt":"Люди услышали, что любой крестившийся получает подарки от церкви. И они пришли: %arg1","loc":"случайное событие миграция 1"};
locObj.people_arrive = {"txt":"Люди услышали, что вы добрый правитель. И они пришли: %arg1","loc":"случайное событие миграция 2"};
...
locObj.deadCounselorDemolish = {"txt":"Ваш советник умер.\nНовоназначенный советник рекомендует вам\nпересмотреть выбор, сделанный при прошлом:\n-настало время, милорд, когда мы можем решить что лучше для нашего города.\n-если вы согласны, мы снесём %arg1 и вы сможете построить %arg2", "loc":""}

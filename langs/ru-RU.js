...
localeStrings.push("Это здание и его улучшения нужны, чтобы сохранить ваши деньги от воров, в случае если они обкрадут сокровищницу.<br>Более высокий уровень тайника позволяет спрятать больше денег.");
...
locObj.skipTutorial = {"txt": "Мне не нужны советы!", "loc": "Не показывать обучающие сообщения"};

locObj.tutorial0_w0 = {"txt":"Ваш дядя, лендмейстер Тевтонского Ордена,\nпослал вас основать город на границе с язычниками.\nВы нашли подходящее место с холмом, рекой и лесом.\nВаши крестьяне уже расчистили площадку и готовы начать стройку", "loc":"Приветственное сообщение"};
locObj.tutorial1_pop0 = {"txt":"Герр Комтур, вам нужно построить дома, чтобы население могло расти", "loc":"Первый раз по окончанию хода и упирания в лимит численности"};
locObj.tutorial_defense = {"txt":"Герр Комтур, разведчики доложили о воруженных людях\n в ближайших лесах. Вам следует построить крепостную стену и обезопасить жителей", "loc":"сообщение из туториала при разблокировке защитных зданий"};
locObj.tutorial_treasury = {"txt":"Герр Комтур, золотой запас растёт\nПостройте сокровищницу, чтобы хранить больше золота", "loc":"tutorial msg when treasury is unlocked"};
locObj.tutorial_treasury_guards = {"txt":"Герр Комтур, теперь вы можете нанять охранников в сокровищнице\nИх наличие снижает шанс на кражу из сокровищницы", "loc":"tutorial msg when treasury is built"};
locObj.tutorial_stash = {"txt":"Герр Комтур, воры украли золото из сокровищницы!\nПостройте тайник, чтобы спрятать часть золота", "loc":"tutorial msg when first stealing has a place"};
locObj.tutorial_stable = {"txt":"Герр Комтур, теперь вы можете построить конюшню.\nВ конюшне вы сможете нанимать сержантов и рыцарей", "loc":"tutorial msg when reached 50 pop"};
...
locObj.tutorial_new_buildings = {"txt":"Новые здания будут доступны по мере роста населения","loc":"tutorial"}

locObj.story1_catastrophe = {"txt":"Ваши войска схватили ведьму. Суд был быстрым.\nПока люди собирались, чтобы посмотреть казнь,\nведьма начала петь. Когда языки огня коснулись её ног, её пение перешло в крик\nВ этот момент с ясного неба ударила молния титанической силы\nровно в центр кострища...", "loc":"tutorial msg катастрофа"};
locObj.story2_two_steps = {"txt":"Вы увидели крестьян, в ужасе убегающих от уродливых монстров, коих никогда не раньше не встречали ни вы, ни ваши братья\nВаш отряд победил монстров, и вы спросили крестьян, что случилось.\nОни ответили, что тролли выбесились, потому что крестьяне не смогли заплатить за право прохода по их теснине", "loc":"tutorial. when you step 2 times from city"};


locObj.unit_sergeants = {"txt": "Сержанты", "loc": "Лог автобоя, юнит игрока"};
locObj.unit_turkopols = {"txt": "Туркополы", "loc": "Лог автобоя, юнит игрока"};
locObj.unit_knights = {"txt": "Братья-рыцари", "loc": "Лог автобоя, юнит игрока"};

locObj.unit_bandit = {"txt": "Бандиты", "loc": "Лог автобоя, противник"};
...
locObj.autobattle_journal_log_end = {"txt": "Конец раунда", "loc": "Показывает конец раунда"};
locObj.autobattle_journal_log_dmg = {"txt": "Отряд %arg1 наносит %arg2 ед. урона по %arg3.", "loc": "Лог боя со значениями нанесенного урона"};
locObj.autobattle_journal_log_dead = {"txt": "Погибло %arg1 %arg2.", "loc": "Лог боя с кол-вом погибших"};
locObj.autobattle_journal_log_destroyed = {"txt": "Отряд %arg1 уничтожен.", "loc": "Отряд уничтожен"};

locObj.advmap = {"txt":"Для движения героя, используй клавиши-стрелки\nДля поддержки сенсорного экрана, включите Мобильный UI в настройках", "loc":"когда впервые игрок посещает карту приключений"};
...
locObj.plague_army = {"txt":"фигня случается: вспышка чумы была остановлена гарнизоном, но унесла жизни %arg1 ваших солдат", "loc":"Случайное событие - чума. Остановлена гарнизоном с потерями в гарнизоне"};
...
locObj.new_adepts = {"txt":"Люди услышали, что любой крестившийся получает подарки от церкви, и пришли в ожидании даров: %arg1","loc":"случайное событие миграция 1"};
locObj.people_arrive = {"txt":"Люди услышали, что вы добрый правитель, и пришли к вам: %arg1","loc":"случайное событие миграция 2"};
locObj.people_leave = {"txt":"Люди покинули вас из-за вашей жестокости. Ушло: %arg1","loc":"случайное событие миграция 3"};
...
locObj.autobattleTitle = {"txt": "Битва-%arg1", "loc": "Заголовок аккордеона в логах битвы"};
...
locObj.equipmentTitle = {"txt": "Экипировано", "loc": "Заглавие экипированных элементов"};
...
locObj.glyphKnightTile = {"txt": "Глиф Рыцарской Доблести", "loc": "Имя артефакта"};
locObj.glyphKnightDesc = {"txt": "Увеличивает атаку героя на +10, увеличивает защиту героя на +6", "loc": "Описание артефакта"};

locObj.glyphMonkTile = {"txt": "Глиф Монашеской Добродетели", "loc": "Имя артефакта"};
locObj.glyphMonkDesc = {"txt": "Увеличивает атаку героя на +4, увеличивает защиту героя на +12", "loc": "Описание артефакта"};

locObj.goldRuneTitle = {"txt": "Руна Золотого Поиска", "loc": "Имя артефакта"};
locObj.goldRuneDesc = {"txt": "Увеличивает награду героя золотом после боя на 7%.", "loc": "Описание артефакта"};

locObj.lifebloodVialTitle = {"txt": "Склянка жизненной силы", "loc": "Имя артефакта"};
locObj.lifebloodVialDesc = {"txt": "Увеличивает показатель здоровья всех юнитов армии героя на +3", "loc": "Описание артефакта"};

locObj.darkPactSwordTitle = { "txt": "Меч Темного Договора", "loc": "Имя артефакта" };
locObj.darkPactSwordDesc = {"txt": "Увеличивает атаку героя на +15, уменьшает здоровье всех юнитов в армии героя на -35%", "loc": "Описание артефакта"};

locObj.crusadersSwordTitle = { "txt": "Меч Крестоносца", "loc": "Имя артефакта" };
locObj.crusadersSwordDesc = {"txt": "Увеличивает атаку всех юнитов в армии героя на +20%", "loc": "Описание артефакта"};

locObj.ringStrengthTitle = {"txt": "Кольцо Силы", "loc": "Имя артефакта"};
locObj.ringStrengthDesc = {"txt": "Увеличивает атаку героя на +5, увеличивает атаку всех юнитов в армии героя на +10%", "loc": "Описание артефакта"};

locObj.ringProtectionTitle = {"txt": "Кольцо Защиты", "loc": "Имя артефакта"};
locObj.ringProtectionDesc = {"txt": "Увеличивает защиту героя на +5, увеличивает защиту всех юнитов в армии героя на +10%", "loc": "Описание артефакта"};

// TODO: #SwordRestriction remove it later
locObj.swordsWarn = { "txt": 'Герой может унести только два меча!', "loc": 'Ограничение меча' };
locObj.ringsWarn = { "txt": 'Герой может надеть только два кольца!', "loc": 'Ограничение кольца' };


locObj.advmapHeroLose = {"txt": "Ваши войска потерпели поражение и герой вынужден отступить в город.", "loc":"Происходит, когда герой терпит поражение на карте приключений"}
